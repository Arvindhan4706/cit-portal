...
export default function FacultyPortal() {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-slate-950 via-slate-900 to-slate-950 text-white p-6 md:p-12 relative overflow-hidden">
      ...
      <nav className="max-w-6xl mx-auto flex items-center justify-between py-6 mb-8 border border-white/10 relative z-10 bg-white/[0.02] backdrop-blur-3xl px-8 rounded-3xl shadow-[0_8px_32px_0_rgba(0,0,0,0.3)]">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <div className="text-[10px] text-sky-400 font-mono tracking-widest uppercase">Student Verification</div>
          </div>
        </div>
      ...
      <main className="max-w-4xl mx-auto mt-20 space-y-10 text-center relative z-10">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6 pt-12">
          <Link href="/faculty/scanner" className="group flex items-center justify-center gap-3 px-10 py-5 bg-white/[0.03] backdrop-blur-3xl border border-sky-500/30 hover:bg-sky-600/20 text-sky-400 rounded-3xl font-bold transition-all shadow-[0_8px_32px_0_rgba(0,0,0,0.4)] hover:shadow-[0_0_40px_rgba(14,165,233,0.3)] w-full sm:w-auto relative overflow-hidden">
        ...
        <div className="grid md:grid-cols-2 gap-8 mt-16 text-left">
          ...
          <div className="p-10 rounded-[2rem] bg-white/[0.02] border border-white/10 backdrop-blur-2xl hover:bg-white/[0.04] transition-colors shadow-[0_8px_32px_0_rgba(0,0,0,0.3)] relative overflow-hidden group">
            <div className="absolute inset-0 bg-gradient-to-br from-white/[0.05] to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" />
            <CheckCircle className="w-10 h-10 text-sky-400 mb-6 drop-shadow-[0_0_15px_rgba(14,165,233,0.5)] relative z-10" />
